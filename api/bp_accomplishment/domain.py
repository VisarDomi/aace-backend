...
def get_all_accomplishments(user_id):
    ...
    list_of_accomplishments = [
        accomplishment.to_dict(max_nesting=2) for accomplishment in accomplishments
    ]
