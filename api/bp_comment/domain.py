...
def get_communication_comments(communication_id):
    comments = backend.get_comments(communication_id)
    comments_list = []
...
def update_communication_comment(comment_data, communication_id, comment_id):
    comment = backend.update_comment(comment_data, communication_id, comment_id)
    comment_dict = comment.to_dict()
...
def get_event_comments(event_id):
    comments = backend.get_comments(event_id)
    comments_list = []
    for comment in comments:
        comment_dict = comment.to_dict()
...
def update_event_comment(comment_data, event_id, comment_id):
    comment = backend.update_comment(comment_data, event_id, comment_id)
    comment_dict = comment.to_dict()
...
def delete_event_comment(event_id, comment_id):
    backend.delete_comment(event_id, comment_id)
...
def get_poll_comments(poll_id):
    comments = backend.get_comments(poll_id)
    comments_list = []
    for comment in comments:
        comment_dict = comment.to_dict()
...
def update_poll_comment(comment_data, poll_id, comment_id):
    comment = backend.update_comment(comment_data, poll_id, comment_id)
    comment_dict = comment.to_dict()
...
def delete_poll_comment(poll_id, comment_id):
    backend.delete_comment(poll_id, comment_id)
