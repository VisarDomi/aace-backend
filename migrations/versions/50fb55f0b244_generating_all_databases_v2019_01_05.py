"""generating all databases v2019-01-05

Revision ID: 50fb55f0b244
Revises: 
Create Date: 2019-01-05 16:25:26.296441
...
def upgrade():
    ...
    sa.Column('register_status', sa.String(length=200), nullable=True),
